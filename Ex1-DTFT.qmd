...
::: {.fragment .escrita-estavel style="color: #00eeff; font-family: 'Courier New', monospace; font-size: 1.5em;"}
Como a soma de todos os valores de $h[n]$ é positiva e não há alternância de sinal que gere cancelamento DC, concluímos que o sistema atua como um **Filtro Passa-Baixas**. Além disso é causal (pois $h[n] = 0$ para $n < 0$) e estável pois o somatório $\displaystyle \sum_{0}^{\infty}|h[n]| < \infty$.
:::
